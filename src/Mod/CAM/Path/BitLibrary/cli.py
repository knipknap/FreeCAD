...
import sys
import argparse
from . import ToolDB, Tool, Library, serializers
...
def run(argv=None):
    ...
    If argv is None, parses sys.argv[1:]. Otherwise, parses the provided list.
    """
    if argv is None:
        args = parser.parse_args()  # Default: parse sys.argv[1:]
    else:
        args = parser.parse_args(argv) # Parse provided list
